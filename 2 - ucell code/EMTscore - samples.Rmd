...
# file information
allDatasets <- c("1-Pastushenko",
                 "2-vanDijk", "2-vanDijk", "2-vanDijk", "2-vanDijk", "2-vanDijk", "2-vanDijk",
                 "3-Cook", "3-Cook", "3-Cook", "3-Cook", "3-Cook")
allSamples <- c("Pastushenko",
                "TGFb-day8_rep1", "TGFb-day8_rep2", "TGFb-day10_rep1", "TGFb-day10_rep2", "Zeb1_rep1", "Zeb1_rep2",
                "A549-TGFB1", "DU145-TGFB1", "OVCA420-EGF", "OVCA420-TGFB1", "OVCA420-TNF")
...
```{r, fig.height=3, fig.width=4.5, family="Helvetica"}
...
plot(NA, xlim=c(0,0.6), ylim=c(0,20),
     #main="EMTscore Distributions,\nMSigDB EMT Hallmark Genes",
     xlab="EMTscore", ylab="Density")

cols <- c('black',
          brewer.pal(n=7, name="Blues")[2:7],
          brewer.pal(n=6, name="YlOrRd")[2:6])

for (i in 1:length(all_kds)) {
  lines(all_kds[[i]], col=cols[i], lwd=2)
}

legend_labels <- c("Mouse SCC, in vivo",
                   "HMLE stim. TGFb, 8d",
                   "HMLE stim. TGFb, 8d",
                   "HMLE stim. TGFb, 10d",
                   "HMLE stim. TGFb, 10d",
...
# To save:
# Copy paste this cell into console, run
# Plots tab: Export image
# In Illustrator, you may have to remove "clip paths"
```
